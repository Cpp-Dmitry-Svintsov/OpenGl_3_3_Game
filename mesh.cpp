...
AMesh::AMesh(std::vector <SVertex>& vertices, std::vector <GLuint>& indices, std::vector <ATexture*> &textures,
	...
	:Instancing(instancing)
{
	...
	VAO.LinkAttrib(vbo, 0, 3, GL_FLOAT, sizeof(SVertex), (void*)0);
	VAO.LinkAttrib(vbo, 1, 3, GL_FLOAT, sizeof(SVertex), (void*)(3 * sizeof(float)));
	VAO.LinkAttrib(vbo, 2, 3, GL_FLOAT, sizeof(SVertex), (void*)(6 * sizeof(float)));
	VAO.LinkAttrib(vbo, 3, 2, GL_FLOAT, sizeof(SVertex), (void*)(9 * sizeof(float)));
